...
def get_model_and_params(env, ALGO, features_extractor_class, scenario_name, logdir, override_params={}, rewards=""):
...
def train(model, parameters, n_eval_episodes, total_training_timesteps,
                  eval_freq, save_dir, logdir, dump_info):
