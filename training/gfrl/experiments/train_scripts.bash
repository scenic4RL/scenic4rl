...
python run_multirl.py --scenario 3v2_counterattack --mode all --id 1
python run_multirl.py --scenario 2v2_counterattack --mode all --id 2
python run_multirl.py --scenario 3v2_counterattack --mode all --id 2
python run_multirl.py --scenario 2v2_counterattack --mode all --id 3
python run_multirl.py --scenario 3v2_counterattack --mode all --id 3
python run_multirl.py --scenario 2v2_counterattack --mode all --id 4
python run_multirl.py --scenario 3v2_counterattack --mode all --id 4
