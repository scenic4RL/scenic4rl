...
# Left
ego = LeftGK with behavior RunRight()

p1 = LeftPlayer with role "LM", in left_start, with behavior RunRight()
p2 = LeftPlayer with role "CF", in left_open_top_right, with width 1.5, with length 1.5, with bahavior RunRight()
p3 = LeftPlayer with role "RM", in left_open_top_right, with width 1.5, with length 1.5, with bahavior RunRight()

# Right
o0 = RightGK with behavior RunRight()
o1 = RightPlayer with role "RB", in right_back, with behavior RunRight()
...
#    mixed_left.append(LeftPlayer with role lr, with width 1.5, with length 1.5, in cluster_top_left, with bahavior RunRight())

#for rr in right_roles:
#    mixed_right.append(RightPlayer with role rr, with width 1.5, with length 1.5, in cluster_top_left, with bahavior RunRight())

# Ball
ball = Ball right of p1 by 20